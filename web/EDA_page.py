...
def show_eda_page():
        ...
        st.markdown("Our complete methodology, including data cleaning, preprocessing, and model training steps, is meticulously documented in our repositories on Kaggle[https://www.kaggle.com/code/icliu30/nba-cumulative-injury-prediction] and GitHub[https://github.com/ICLiu30]. We strongly encourage interested readers to delve deeper into our work for a comprehensive understanding of our process and insights. We believe this will enable you to appreciate the depth and rigor of our approach.")
